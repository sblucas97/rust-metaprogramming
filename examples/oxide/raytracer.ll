...
bb3:
  ...
  %v33 = fdiv contract float %v25, 2.0
  %v34 = fsub contract float %v32, %v33
  %v35 = uitofp i32 %v31 to float
  %v36 = fsub contract float %v35, %v33
  br label %bb4
bb4:
  %v37 = phi float [ 0.0, %bb3 ], [ %v99, %bb20 ]
  %v38 = phi float [ 0.0, %bb3 ], [ %v100, %bb20 ]
  %v39 = phi float [ 0.0, %bb3 ], [ %v101, %bb20 ]
  %v40 = phi float [ -99999.0, %bb3 ], [ %v102, %bb20 ]
...
bb13:
  br label %bb14
bb14:
  %v78 = phi float [ %v139, %bb12 ], [ 0.0, %bb13 ]
  %v79 = phi float [ %v77, %bb12 ], [ -99999.0, %bb13 ]
...
bb23:
  ...
  %v112 = fmul contract float %v37, 255.0
  %v113 = fmul contract float %v38, 255.0
  %v114 = fmul contract float %v39, 255.0
  ...
  store float 255.0, ptr %v118, align 4
...
define { i64, i64 } @_RINvNtNtCsiWbdGYq5HZh_11cuda_device6thread10___internal16index_2d_runtimeNtCs6HixiQUBNAA_9raytracer4RgbaNtB2_13UnknownDomainNtB2_17NativeCoordinatesEB1b_(ptr %v0, ptr %v1) alwaysinline #0 {
entry:
  br label %bb0
bb0:
  %v2 = phi ptr [ %v0, %entry ]
